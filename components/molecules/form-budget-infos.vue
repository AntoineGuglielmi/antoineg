<template>
  <div>
    <form>
      ...
      <div class="form__group">
        <label for="saving" class="label__label label__checkbox" :class="{ 'label__active': saving }">
          Épargne
      ...
      <div class="form__row">
        <div class="form__group">
          <label for="in" class=" label__label label__radio" :class="{ 'label__active': flux === 'Crédit' }">
            Crédit
            <input type="radio" id="in" value="Crédit" v-model="flux" @change="update('flux')">
          </label>
        </div>
        <div class="form__group">
          <label for="out" class="label__label label__radio" :class="{ 'label__active': flux === 'Débit' }">
            Débit
      ...
      <div class="form__row">
        ...
        <div class="form__group">
          <label for="name-asc" class="label__label label__radio" :class="{ 'label__active': sort_costs === 'name:asc' }">
            <div class="tac">
              <Atoms-Icons-A-To-Z />
            </div>
        ...
        <div class="form__group">
          <label for="name-desc" class="label__label label__radio" :class="{ 'label__active': sort_costs === 'name:desc' }">
            <div class="tac">
              <Atoms-Icons-Z-To-A />
            </div>
        ...
        <div class="form__group">
          <label for="amount-asc" class="label__label label__radio" :class="{ 'label__active': sort_costs === 'amount:asc' }">
            <div class="tac">
        ...
        <div class="form__group">
          <label for="amount-desc" class="label__label label__radio" :class="{ 'label__active': sort_costs === 'amount:desc' }">
            <div class="tac">
      ...
      <div class="form__row">
        <div class="form__group"><button class="button--regular button--orange button--center" id="budget__empty" @click.prevent="emptyBudget">Vider le budget</button></div>
        <div class="form__group"><button class="button--regular button--rouge button--center" id="budget__delete" @click.prevent="deleteBudget">Supprimer le budget</button></div>
      </div>
    </form>
